...
if ~exist('schans1',   'var'), schans1   = -1;       end % selected channels (empty for all good, negative for ROI number)
if ~exist('schans2',   'var'), schans2   = -6;       end % selected channels (empty for all good, negative for ROI number)
...
[chans1,chanstr1] = select_channels(BP,subject,task,schans1,badchans,1);
[chans2,chanstr2] = select_channels(BP,subject,task,schans2,badchans,1);

[chans,chanstr,~,ogchans] = select_channels(BP,subject,task,[chans1 chans2],badchans,0);

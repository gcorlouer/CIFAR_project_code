...
if ~isfield(S_brain,'meshdir'); S_brain.meshdir='/its/home/gc349/CIFAR_data/CIFAR/iEEG_10/subjects'; end
...
if ismember(S_brain.plotsurf,{'flat', 'inflated'})
    load('/its/home/gc349/EcoG_mapping/plot_brain_example_code/default_freesrufer_surface/SUMA_default.mat');
else
    load('/its/home/gc349/EcoG_mapping/plot_brain_example_code/default_freesrufer_surface/SUMA_pial_blank.mat');
...
if strcmpi(S_brain.plotsurf,'pial')
    ...
    mex smoothpatch_curvature_inversdistance_path
    mex vertex_neighbours_double_path

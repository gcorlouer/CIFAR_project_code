...
% S_brain              = struct;
% S_brain.plotsurf     = 'pial', 'inflated';  % either pial/inflated cortical surface
% S_brain.layout       = 'compact', 'full';   % either compact/full (different layouts for examples)
% S_brain.surfacealpha = 1;                   % alpha value for surface transperancy
% S_brain.meshdir      = cfsubdir;            % cfsubir in startup file, input folder where the brain and electrode structures are stored
...
%%%%%%%%
% S_brain
% H : Figure Handle (useful to plot electrodes afterwards)
% SUMAsrf : Surface type (contains elec coordinate)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Default

if isempty(subjid); subjid                                = 'FsAv';                                   end
...
if ~isfield(S_brain,'meshdir'); S_brain.meshdir           = cfsubdir; end 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if subjid == 'FsAv'
    meshDir = fullfile(S_brain.meshdir,'AnRa','brain','default_freesrufer_surface'); % Chose any subject since default surface
else
    meshDir = fullfile(S_brain.meshdir,subjid,'brain');
end
...
if ismember(S_brain.plotsurf,{'flat', 'inflated'})
    load(fullfile(S_brain.meshdir,subjid,'brain','default_freesrufer_surface','SUMA_ROI_DKTatlas.mat'))

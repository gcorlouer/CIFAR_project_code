...
global mvgc_root;
mvgc_root = fullfile(fileparts(CIFAR_root),'mvgc'); % i.e. same directory level as CIFAR !!! AMEND IF NECESSARY !!!
...
cfdatadir  = fullfile(datadir,'CIFAR');

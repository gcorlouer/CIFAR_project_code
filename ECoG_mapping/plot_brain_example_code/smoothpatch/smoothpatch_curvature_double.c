...
//  int VertexNA[1]={0};
    ...
    double e1x, e1y, e1z, e1l;   plhs[0] = mxCreateDoubleMatrix(VertexN, 1, mxREAL);
    plhs[1] = mxCreateDoubleMatrix(VertexN, 1, mxREAL);
    plhs[2] = mxCreateDoubleMatrix(VertexN, 1, mxREAL);
...
// VertexNA[0]=VertexN;
   plhs[0] = mxCreateDoubleMatrix(VertexN, 1, mxREAL);
   plhs[1] = mxCreateDoubleMatrix(VertexN, 1, mxREAL);
   plhs[2] = mxCreateDoubleMatrix(VertexN, 1, mxREAL);
